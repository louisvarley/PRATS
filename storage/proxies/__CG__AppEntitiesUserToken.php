 ...
 */
class UserToken extends \App\Entities\UserToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'token', 'expires', 'user'];
        }
    ...
    public function expire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'expire', []);
