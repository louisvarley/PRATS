...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'apikey', '' . "\0" . 'App\\Entities\\User' . "\0" . 'passwordHash', 'userRole', 'rats', 'litters', 'affiliation', 'code', 'firstName', 'lastName', 'addressLine1', 'addressLine2', 'town', 'county', 'country', 'postcode', 'telephone', 'image'];
        }
    ...
    public function generateApiKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'generateApiKey', []);
